...
public sealed class CreateCustomerViewModel : ViewModelBase
{
    ...
    public CreateCustomerViewModel(IMediator mediator)
    {
        _mediator = mediator;
    ...
    public async Task SaveAsync()
    {
        ...
        var command = new CreateCustomerCommand(
            FirstName, LastName, PhoneNumber, Email, Street, City, PostalCode, Country);
